...
def test_active_policy_definition_and_rule_remain_semantically_aligned() -> None:
    ...
    concept = registry.concepts["ciferp:ActiveSalesOrder"]
    rule = registry.rules["ciferp:ActiveSalesOrder"]
    metric = registry.metrics["ciferp:ActiveSalesOrderCount"]
    ...
    assert metric.filter_rule == "ciferp:ActiveSalesOrder"
