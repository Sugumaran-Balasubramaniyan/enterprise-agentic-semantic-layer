...
Databricks, Snowflake, and Microsoft Fabric representations are documentation
examples only. Their adapters fail closed until their own credentials,
configuration, and platform-native security controls are deliberately supplied.
